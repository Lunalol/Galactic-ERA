...
(
    `color` ENUM ('neutral','FF3333','00CC00','6666FF','FF9900','CD1FCD','FFFF00'),
	`type` ENUM ('star','relic','dominationCard','fleet'),`id` INT,
...
(
	id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, trigger_state INT(4),
...
ALTER TABLE player ADD `skipDM` BOOL DEFAULT false;
